...
#define DECLARE_FIXTURE_ATOI(N)                                                       \
    ...
    BENCHMARK_F(FixtureATOI_##N, atoi)(benchmark::State & state)                      \
    {                                                                                 \
        lambda_atoi(state, inputs);                                                   \
    }                                                                                 \
    BENCHMARK_F(FixtureATOI_##N, atoi_naive)(benchmark::State & state)                \
    {                                                                                 \
        lambda_atoi_naive(state, inputs);                                             \
    }                                                                                 \
    BENCHMARK_F(FixtureATOI_##N, atoi_vectorization)(benchmark::State & state)        \
    {                                                                                 \
        lambda_atoi_vectorization(state, inputs);                                     \
    }                                                                                 \
    BENCHMARK_F(FixtureATOI_##N, atoi_vectorization_unroll)(benchmark::State & state) \
    {                                                                                 \
        lambda_atoi_vectorization_unroll(state, inputs);                              \
    }
